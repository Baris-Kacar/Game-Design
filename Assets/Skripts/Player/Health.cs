...
public class Health : MonoBehaviour
{
    ...
    void Start() {
        ...
        // Aktiviere den Rigidbody2D des Spielers oder f�ge ihn hinzu, wenn er nicht vorhanden ist
        ...
        // Aktiviere alle anderen Skripte, die die Bewegung beeinflussen k�nnten
        if (playerMovement != null) {
            playerMovement.enabled = true;
        }
        // Setze die Zeit zur�ck, falls sie pausiert wurde
        Time.timeScale = 1f;
    }
    ...
    void Update() {
        if (isDead) {
            ...
            // Deaktiviere alle anderen Skripte, die die Bewegung beeinflussen k�nnten
            if (playerMovement != null) {
